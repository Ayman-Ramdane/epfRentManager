 ...
 * Generated at: 2022-02-28 15:40:52 UTC
...
public final class create_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tonkeypress=\"return /[a-z]/i.test(event.key)\" required>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"seats\" placeholder=\"Nombre de places\" min=2 max=7\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\trequired>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<!--\n");
