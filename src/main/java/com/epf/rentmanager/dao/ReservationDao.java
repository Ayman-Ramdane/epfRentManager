...
public class ReservationDao {
	...
	private static final String FIND_RESERVATIONS_CLIENTS_VEHICLES_QUERY = "SELECT * FROM Reservation AS R JOIN Vehicle AS V ON R.vehicle_id = V.id JOIN Client AS C ON C.id = R.client_id;";
